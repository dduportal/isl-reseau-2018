...
* Appartient à 2 réseaux : 1 parent et 1 enfant (le nôtre)

== Et Caetera

* La passerelle étant elle-même un noeud du réseau "parent"
** Soit le destinataire est dans son réseau parent
** Soit elle transmet à la passerelle du réseau parent

...
// TODO Image réseau initial

== NAT/PAT en images

* Requête de `192.168.0.1` vers www.google.com (`72.81.154.234`)
* Sortie
// TODO : plusieurs slides faisdant le

== Port Forwarding

image::port-forwarding.jpg[height=550]

// TODO: Wireshark pour protocole TCP ?

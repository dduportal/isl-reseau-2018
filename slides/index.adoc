...
* icon:envelope[] mailto:damien.duportal@gmail.com[damien.duportal@gmail.com]
...
include::./includes/couches.adoc[]
include::./includes/topologies.adoc[]
include::./includes/tcp-ip.adoc[]
